...
export class MainScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.chargingStationStats = new ChargingStationStats(this, this.routeGraphics, this.clock, this.eventDispatcher);
    ...
    this.eventDispatcher.on("editchargingstation", (chargingStation: ChargingStation) => {
      this.chargingStationSelection.modify(chargingStation);
    });
    this.eventDispatcher.on("updatechargingstation", (chargingStation: ChargingStation) => {
      this.controller.activateWaitingVehicle(chargingStation);
      this.routeGraphics.updateChargingStation(chargingStation);
    });
